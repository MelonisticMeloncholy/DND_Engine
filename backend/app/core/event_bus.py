...
Now includes Tactician for combat state management.
"""
...
async def dispatch(
    ...
    # ── Combat handling ───────────────────────────────────────────────────────
    # StateExtractor sets _combat_started/_combat_ended flags
    # Tactician then reads the updated context and returns full combat state
    ...
    # If combat is already active, push updated combat state every turn
